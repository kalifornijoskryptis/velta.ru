...
<div class="content">
  <div class="wrapper">
	<h1>Общая информация о креслах из Википедии</h1>
	...
	<table>
		...
		<tr>
			<td>Кресло «Новый стиль»</td>
			<td>Мягкая спинка, удобный изгиб</td>
			<td>Поворот на 270-360 градусов</td>
			<td>от 15 000 руб.</td>
		</tr>
		<tr>
			<td>Изящный столик «Перо»</td>
			<td>Выполнен из красного дерева</td>
			<td>Легкий, весит 600 г.</td>
			<td>от 219 000 руб.</td>
		</tr>
		<tr>
			<td>Кровать «Виктория»</td>
			<td>Большая кровать с матрацем</td>
			<td>Красивые подголовники</td>
			<td>от 95 000 руб.</td>
		</tr>
		<tr>
			<td>Кровать «Семейная»</td>
			<td>Обычная кровать</td>
			<td>Нет</td>
			<td>от 1 000 руб.</td>
		</tr>
	</table>
	...
	<p><q>Обращаясь в магазины Велты, вы экономите массу вашего времени и денег</q>, — рекомендует Моника Салайскайте.</p>
	...
	<figure>
	  ...
	  <figcaption>Новая коллекция нашей мебели</figcaption>
	</figure>
  </div>
</div> <!--//.wrapper//-->
